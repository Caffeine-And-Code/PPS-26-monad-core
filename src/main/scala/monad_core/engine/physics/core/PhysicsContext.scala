 ...
 *
 * @see [[monad_core.engine.geometry.Collision]] and [[PhysicsContext.detect]]
 ...
 *   ([[monad_core.engine.collision_detection.CollisionDetector]])
 */
 ...
 *
 * @see [[CollisionSnapshot]], [[monad_core.engine.core.traits.State]] and [[PhysicsRule]]
...
object PhysicsContext:
   ...
   * [[monad_core.engine.collision_detection.CollisionDetector]] and produces the initial
   * [[PhysicsContext]] for the first rule to be executed
   *
   * @see [[monad_core.engine.physics.combinators.RuleCombinator]]
