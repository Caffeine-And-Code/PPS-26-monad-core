...
case class RGBValueCannotExceedRange() extends EngineError("An RGB value cannot exceed the range of [0,255]")

case class HueValueCannotExceedRange() extends EngineError("An Hue value cannot exceed it's range of [0,360]")

case class PercentValueCannotExceedRange() extends EngineError("A Percent value cannot exceed it's range of [0,100]")
