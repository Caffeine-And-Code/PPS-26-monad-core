 ...
 *
 * @param errorMessage
 *   original engine error message
 */
final case class EnginePerformanceError(errorMessage: String)
    extends PerformanceError(s"Engine workload failed: $errorMessage")
