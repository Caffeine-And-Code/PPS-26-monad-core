...
object SaveSurfaceFormDialog:
  ...
  private[forms] def buildFields(defaultValues: SaveSurfaceFormDefaultValues): Seq[FormFieldSpec] =
    Seq(
      TextFieldSpec(id = SurfaceFormParser.PositionXKey, label = "Initial X Position", defaultValue = defaultValues.x),
      TextFieldSpec(id = SurfaceFormParser.PositionYKey, label = "Initial Y Position", defaultValue = defaultValues.y),
      SelectFieldSpec(
      ...
      TextFieldSpec(id = SurfaceFormParser.AppliedForceXKey, label = "Applied Force X", defaultValue = defaultValues.appliedForceX),
      TextFieldSpec(id = SurfaceFormParser.AppliedForceYKey, label = "Applied Force Y", defaultValue = defaultValues.appliedForceY),
      TextFieldSpec(id = SurfaceFormParser.FrictionIndexKey, label = "Friction Index", defaultValue = defaultValues.frictionIndex),
    )
