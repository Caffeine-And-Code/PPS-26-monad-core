...
import monad_core.simulator.application.performance.{PerformanceExecutor, PerformanceRequest}
 ...
 */
object PerformanceCli extends PerformanceExecutor:
  export PerformanceExecutor.*
