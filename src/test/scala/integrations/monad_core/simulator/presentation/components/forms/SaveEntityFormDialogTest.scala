...
class SaveEntityFormDialogTest
    extends AnyFunSuite
    with Inside
    with Matchers
    with MockFactory
  ...
  test("SaveEntityFormDialog displays visually the circle entity values passed"):
    ...
    onFxThread {
      ...
      assertMatchesVisualSnapshot(
        "edit_circle_entity_form_dialog",
        rootNode,
  ...
  test("SaveEntityFormDialog displays visually the rectangle entity values passed"):
    ...
    onFxThread {
      ...
      assertMatchesVisualSnapshot(
        "edit_rectangle_entity_form_dialog",
        rootNode,
        maxDiffPercentage = 10.0
      )
    }
  ...
  test("SaveEntityFormDialog Circle matches visual snapshot"):
    ...
    onFxThread {
      ...
      assertMatchesVisualSnapshot(
        "save_circle_entity_form_dialog_initial",
        rootNode,
  ...
  test("SaveEntityFormDialog Rectangle matches visual snapshot"):
    ...
    onFxThread {
      ...
      assertMatchesVisualSnapshot(
        "save_rectangle_entity_form_dialog_initial",
        rootNode,
        maxDiffPercentage = 9.2
      )
    }
