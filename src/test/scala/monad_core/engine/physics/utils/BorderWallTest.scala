...
class BorderWallTest extends AnyFunSuite
  with Matchers:
  ...
  test("this function should create an entity for a margin on the left side of the scene"):
    ...
    collision.penetrationDepth shouldBe math.abs(UpperLeftCorner.x - (entity.position.x - DefaultRadius))
  ...
  test("this function should create an entity for a margin on the right side of the scene"):
    ...
    collision.penetrationDepth shouldBe math.abs(LowerRightCorner.x - (entity.position.x + DefaultRadius))
    collision.normalVector shouldBe Vector2D(-1, 0)
  ...
  test("this function should create an entity for a margin on the top side of the scene"):
    ...
    collision.penetrationDepth shouldBe math.abs(UpperLeftCorner.y - (entity.position.y - DefaultRadius))
  ...
  test("this function should create an entity for a margin on the bottom side of the scene"):
    ...
    collision.penetrationDepth shouldBe math.abs(LowerRightCorner.y - (entity.position.y + DefaultRadius))
    collision.normalVector shouldBe Vector2D(0, -1)